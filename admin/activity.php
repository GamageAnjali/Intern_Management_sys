...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
			...
			<button type = "button" id = "add_activity" class = "btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Add job</button>
					...
					<table id = "table" class = "table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td><center><a href = "edit_activity.php?activity_id=<?php echo $act_fetch['activity_id']?>" class = "btn btn-primary"><span class=  "glyphicon glyphicon-edit"></span> Update</a> <a href = "#" data-toggle = "modal" data-target = "#delete_activity" name = "<?php echo $act_fetch['activity_id']?>" class = "btn btn-danger activity_id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
							</tr>
							<?php
								}
							?>
