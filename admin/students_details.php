...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
				...
				<button type = "button" id = "add_admin" class = "btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Add New student</button>
				...
				<div id = "a_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php 
									$a_query = $conn->query("SELECT * FROM `registered_users`") or die($conn->error);
								...
								<tr>
									...
									<td><center><a href = "edit_students.php?id=<?php echo $a_fetch['id']?>" class = "btn btn-primary"><span class=  "glyphicon glyphicon-edit"></span> Update</a> <a href = "#" name = "<?php echo $a_fetch['id']?>" data-toggle = "modal" data-target = "#delete_admin" class = "btn btn-danger id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
								</tr>
								<?php
									}
								?>
				...
				<div id = "a_form" style = "display:none;" class = "panel panel-default">
					<div  class = " panel-heading" >	
							...
							<div style = "width:40%; margin-left:32%;">	
								<form method = "POST" action = "add_student_register.php">	
