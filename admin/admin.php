...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
				...
				<button type = "button" id = "add_admin" class = "btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Add Admin</button>
				<button style = "display:none;" type = "button" id = "cancel_admin" class = "btn btn-primary"><span class = "glyphicon glyphicon-hand-right"></span> Cancel</button>
				<br />
				<br />
				<div id = "a_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								<?php 
									$a_query = $conn->query("SELECT * FROM `admin`") or die($conn->error);
								...
								<tr>
									...
									<td><center><a href = "edit_admin.php?admin_id=<?php echo $a_fetch['admin_id']?>" class = "btn btn-primary"><span class=  "glyphicon glyphicon-edit"></span> Update</a> <a href = "#" name = "<?php echo $a_fetch['admin_id']?>" data-toggle = "modal" data-target = "#delete_admin" class = "btn btn-danger admin_id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a></center></td>
								</tr>
								<?php
									}
								?>
