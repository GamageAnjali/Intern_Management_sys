...
<!-------------------SIDEBAR0------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
			...
			<div id = "s_table" class = "panel panel-default">
						...
						<table id = "table" class = "table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><center> <a href = "#" name = "<?php echo $s_fetch['id']?>" data-toggle = "modal" data-target = "#delete_student" class = "btn btn-danger id"><span class=  "glyphicon glyphicon-trash"></span> Delete</a><br>
									<a href = "" data-toggle = "modal" data-target = "#assign-supervisor"  class = "btn btn-primary"> Allocate supervisor</a>
								</center></td>
								</tr>
								<?php
									}
				...
				<div class="modal" id="assign-supervisor" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	...
	<label class="my-1 mr-2" for="inlineFormCustomSelectPref">Supervisor</label>
 

  <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="supervisor">
	...
	<option > 
	<?php echo $a_fetch['id']?>  
	<?php echo $a_fetch['firstname']?>
	<?php echo $a_fetch['lastname']?>
	...
	?>
	 ...
	 <a href="view_allocation.php">View Allocations</a>
