...
$mailto ="kalharianjalee@gmail.com";
$from=$_POST['email'];
$name=$_POST['first_name'];
$subject=$_POST['company_name'];
$subject2="your message submitted successfully";
$message="Client Name:". $name. ",Wort the following message"."\n\n".$_POST['last_name'];
$message2="Dear". $name. "\n\n"."Thank you for contacting us! we will get back to you storly";
$headers="From: ".$from;
$headers2="From: ".$mailto;
$result=mail($mailto,$subject,$message,$headers);
$result2=mail($from,$subject2,$message2,$headers2);
if($result){
echo '<sript type="text/javascript">alert("Message sent. thank you. we will contact you shortly.")</script>';
}else{
echo '<sript type="text/javascript">alert("submission faild!")</script>';
}
}
?>
<!-- ........email send end....... -->
